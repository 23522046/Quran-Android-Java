...
public class TranslationsDBHelper extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        if (oldVersion < 4) {
            ...
            String BACKUP_TABLE = TranslationsTable.TABLE_NAME + "_backup";
            db.beginTransaction();
            try {
    ...
    public static class TranslationsTable {
        ...
        public static final String TRANSLATOR_FOREIGN = "translatorForeign";
        public static final String FILENAME = "filename";
        public static final String URL = "url";
        public static final String LANGUAGE_CODE = "languageCode";
        public static final String VERSION = "version";
        public static final String MINIMUM_REQUIRED_VERSION = "minimumRequiredVersion";
        public static final String DISPLAY_ORDER = "userDisplayOrder";
    }
}
