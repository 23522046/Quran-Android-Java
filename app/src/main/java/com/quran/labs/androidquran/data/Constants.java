public class Constants {
    // Data domain
    public static final String HOST = "https://quran.app/";

    // Numerics
    public static final int DEFAULT_NIGHT_MODE_TEXT_BRIGHTNESS = 255;
    public static final int DEFAULT_NIGHT_MODE_BACKGROUND_BRIGHTNESS = 0;
    public static final int DEFAULT_TEXT_SIZE = 15;

    // 10 days in ms
    public static final long TRANSLATION_REFRESH_TIME = 60 * 60 * 24 * 10 * 1000;

    // 1 hour in ms
    public static final long MIN_TRANSLATION_REFRESH_TIME = 60 * 60 * 1000;
    ...
    public static final String PREF_NIGHT_MODE_BACKGROUND_BRIGHTNESS = "nightModeBackgroundBrightness";
    ...
    public static final String PREF_USE_DYSLEXIC_FONT = "useDyslexicFont";
    public static final String PREF_SPLIT_PAGE_AND_TRANSLATION = "splitPageAndTranslation";
    ...
    public static final String PREF_LAST_UPDATED_TRANSLATIONS = "lastTranslationsUpdate";
    public static final String PREF_HAVE_UPDATED_TRANSLATIONS = "haveUpdatedTranslations";
    ...
    public static final String PREF_EXPORT_CSV = "exportKeyCSV";
    public static final String PREF_LOGS = "sendLogsKey";
    public static final String PREF_DID_PRESENT_PERMISSIONS_DIALOG = "didPresentStoragePermissionDialog";
    ...
    public static final String PREF_SHOW_SIDELINES = "showSidelines";
}
